...
class _CartPageState extends ConsumerState<CartPage> {
  ...
  cartCard() {
    return ref.watch(streamCartProvider).when(
          data: (data) {
                                ...
                                SlidableAction(
                                  onPressed: (context) {
                                    ...
                                    FirebaseFirestore.instance
                                        ...
                                        .update({
                                      "cart":
                                          FieldValue.arrayRemove([data[index]])
                                    }).then((value) async {
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                        spreadRadius: 2,
                                        offset: Offset(0, 4),
                                        color: colors.PrimaryColour.withOpacity(
                                            0.15),
                                        blurRadius: 4)
                                  ]),
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          "${data[index]["ItemDescriptionofslect"]}"),
  ...
  totalPrize() async {
    ...
    for (int i = 0; i < currentUserModel!.cart.length; i++) {
      total = (currentUserModel!.cart[i]['ItemPrice'] *
              currentUserModel!.cart[i]['ItemQty']) +
          total;
    }
            ...
            children: AnimationConfiguration.toStaggeredList(
              ...
              children: [
                Text(
                  "Your cart",
                  style: TextStyle(
                      fontSize: w * 0.05, fontWeight: FontWeight.w600),
                ),
                SizedBox(
                  height: h * 0.02,
                ),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "$total",
                      style: TextStyle(
                          fontSize: w * 0.06, fontWeight: FontWeight.w800),
                    ),
                  ],
                ),
                GestureDetector(
                  onTap: () {
                    currentUserModel!.cart.isEmpty
                        ...
                        : Navigator.push(
                            ...
                            CupertinoPageRoute(
                              builder: (context) => deliveryAddress(
                                  pickedItem: currentUserModel!.cart, price: total,),
                            ));
                  },
                  child: Container(
                    height: h * 0.045,
