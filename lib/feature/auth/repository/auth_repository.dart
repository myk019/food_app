...
// print(data.docs);
    if(data.docs.isEmpty){
      ...
      UserModel userModel = UserModel(name: userName, email: userEmail??'', password: '', image: userImg, id: '');
  ...
  googleNewUser(name,email,password,image,id){
    UserModel userModel=UserModel(name: name, email: email, password: password, image: image, id: id);
    _authuser.add(userModel.toMap());
  }


  UserDetails(name, email, password,image,id) {
